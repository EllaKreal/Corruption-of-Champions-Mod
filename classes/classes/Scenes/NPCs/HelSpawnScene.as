...
public function helspawnsMainMenu():void {
	...
	if(player.isBiped() && player.lust >= 33 && flags[kFLAGS.HELSPAWN_INCEST] == 1 && player.hasCock()){
		addButton(3,"Sex",sexHelspawn);
	}
	//[Appearance]
...
private function sexHelspawn():void {
	...
	outputText(flags[kFLAGS.HELSPAWN_NAME] + " smiles as she answers with a simple, “I’d like that, [name].” \n \n");
	
	outputText("The young lady watches you disrobe. You strip as sensually as your " + player.armorName + " will allow, showing off your form and moving to music only you can hear. You even throw in a few sexy dance moves you saw others do in Ingnam. Your exotic display has " + flags[kFLAGS.HELSPAWN_NAME] + " all a twitter as she shivers with longing. When you’re finally in the buff " + flags[kFLAGS.HELSPAWN_NAME] + "’s eyes drink in your naked form with open hunger. You proudly display your " + player.cockDescript() + " and " + player.buttDescript() + " for her viewing pleasure. Then you thrust your " + player.chestDesc() + " forward and flex your biceps for her. She claps in appreciation of your show, squirming as her arousal takes hold. \n \n");
	...
	if(flags[kFLAGS.HELSPAWN_PERSONALITY] >= 50) {
		...
		outputText("“Fuck yes, [name]” she groans as you take a moment to rub and tease her holes, both in need of a good long fuck.");
	}
	else {
		outputText(flags[kFLAGS.HELSPAWN_NAME] + " takes a moment to unbutton her sky blue blouse before sensually pulling it off, a coy smile playing on her lips. The blouse falls to reveal a single fancy white lace bra. She reaches backward and with a simple motion undoes the clasp. She holds the bra, slowly sliding it down to reveal the gentle curve of her bosom. You reach forward, taking her by the waist and tasting her pert nipples, tugging and sucking them with wet lips until she turns away, blushing. She takes a moment to undo her skirt. The clothing falls to reveal the soft mounds of tender flesh upon which she sits every day. She works her hips as she pulls down the soft white lace panties, revealing her rear entrance and tender glistening womanhood for your viewing pleasure. The scent of your little girl’s arousal wafts around you, a scent so sweet it makes your mouth water. \n \n");

		outputText("“Yes, [name]” she gasps as you take a moment to massage her naked bottom, cupping the squishy flesh and spreading it to see her two waiting entrances.");
	}
	
	outputText("You lean in with every intention of tasting her but she steps away, apparently ignorant of your desire to taste her. It seems great minds think alike, however; she turns to face you and kneels before you as if you were some royal king and she your humble servant. \n \n");
	
	simpleChoices("", null, "", null, "", null, "", null, "Next", sexOralHelspawn);
}
...
private function sexOralHelspawn():void {
	...
	if(player.hasVagina()){ 
		outputText("Helspawn begins by pushing your thighs up and out of her way. She takes one look at your " + player.vaginaDescript() + " and licks her lips before leaning and giving you a gentle teasing lick right next to your moistening lady bits. She teases you for what seems like forever, licking your " + player.skinFurScales() + " and making you shiver and groan. \n \n");
		outputText("Once you’re begging for it she gives your glistening lips a single smooth lick. As her tongue glides across your feminine opening your body begins to heat up. She slurps across your " + player.clitDescript() + " and rubs her face in your folds, with a beautiful smile. \n \n");
	}
	...
	if(player.balls > 0){
		...
		outputText("“Oh... so much bottled up cum.” " + flags[kFLAGS.HELSPAWN_NAME] + " says with a soft moan, “Is all of this just for me, ");
		outputText("[name]");
	...
	if(player.cocks[x].cockType == CockTypesEnum.DOG) outputText("She pulls your " + player.cockDescript() + " up and gives your knot a tender kiss. The kiss quickly evolves into loud sucking that has you trembling. She plays with your knot, lashing its sensitive surface with her hot tongue and nibbling at it with wet lips. The combination of her hot breath, her warm hands and her wet tongue has you on edge. \n \n");
	else if(player.cocks[x].cockType == CockTypesEnum.CAT) outputText("She giggles as she twirls the nubs of your cat dick in her hand. Then she drags her gloriously hot tongue against the surface before reversing and swirling her tongue around each barb. She gently pinches the tip, squeezing pre out of your slit and licking the copious liquid from your drooling and spit shined " + player.cockDescript() + ". The combination of her hot breath, her warm hands and her wet tongue has you on edge. \n \n");
	...
	else if(player.cocks[x].cockType == CockTypesEnum.TENTACLE) outputText(flags[kFLAGS.HELSPAWN_NAME] + " groans as she works your living pecker over. She traps it like prey and lashes her tongue across its writhing belly. It rewards her with juice which she laps up and sucks from the " + player.cockHead() + ". She growls with it poking around inside her lips, vibrating her mouth as her tongue wrestles with your excited " + player.cockDescript() + ". The combination of her hot breath, her warm hands and her wet tongue has you on edge. \n \n");
	else outputText("She takes a moment to explore your " + player.cockDescript() + " further. Her convulsion inducing lips drool on your " + player.cockDescript() + " before loudly sucking it up. She shines your knob with kisses so sweet each gentle smooch is accompanied a deep sound that vibrates your " + player.chestDesc() + ". Her smooth lips begin to glide across your cock’s surface, leaving no stone unturned and no nook unexplored. Then her wet tongue lashes the belly of your quivering " + player.cockDescript() + " over and over again. The combination of her hot breath, warm hands and wet tongue has you on edge. \n \n");
	...
	outputText("“Yes [name].” She groans as you nuzzle her neck, sucking the tender flesh and making her grind against your body. You paint a trail of wet kisses down to her pert tits. You stay there a moment, sucking her erect nipples into your mouth whilst your hands massage her waist. She cringes as you tickle and tease her, giggling like a schoolgirl as she begs for your " + player.cockDescript() + ". \n \n");
	...
	outputText("“[name] please.” She whines with a sexy edge to her voice when she can take no more. \n \n");
	...
	simpleChoices("", null, "", null, "", null, "", null, "Next", sexDoggyHelspawn);
}

public function sexDoggyHelspawn():void {
	clearOutput();
	//var playerCameBeforeRiding:Boolean = false;
	flags[kFLAGS._modPLAYERCAMEBEFORERIDING] = false;
	//DOGGY STYLE TEXT
	...
	if(player.totalCocks() == 1){
		...
		if(player.longestCockLength() <= 8){
			...
			outputText("!” She says, looking over her shoulder with a grin, “Fuck me good.” \n \n");
			...
			outputText(".” Her voices is a fluttering note of ecstasy, “Oh… fuck me good.” \n \n");
		...
		if (flags[kFLAGS.HELSPAWN_HADSEX] == 0){
			...
			outputText(",” she says, still breathless from your recent exertions, “You can play with mine, but I want to play with yours.” She says with a grin as she presses the tip of her tail against your " + player.assholeDescript() + ". You can’t help but verbally note the obvious differences between your " + player.cockDescript() + " and her tail. To which she replies, “You can set the pace… I’ll just follow your lead. I’ll go as deep as you go and as fast as you go.”");
		} else {
			//repeatable 
		...
		if (player.longestCockLength() <= 8) outputText("You push forward, penetrating " + flags[kFLAGS.HELSPAWN_NAME] + "’s vaginal opening as your " + player.cockDescript() + " pushes deeper into her anal canal. She squeezes both of your embedded cocks with her internal muscles and looks back at you, eyes bright with desire. She wants you so bad her lip quivers as you effortlessly sink into her wet pussy.");
		else if (player.longestCockLength() > 8 && player.longestCockLength() <= 12) outputText("You push forward, penetrating " + flags[kFLAGS.HELSPAWN_NAME] + "’s vaginal walls as you push deeper into her anal canal. She gasps, looking back at you with {Helspawn Eye color} eyes glazed over with lust as you sink into her dripping pussy. \n \n");
		else if (player.longestCockLength() > 12) outputText("You push forward, stretching " + flags[kFLAGS.HELSPAWN_NAME] + "’s vaginal walls apart with your " + player.cockDescript() + ". She trembles as your " + player.cockDescript() + " tunnels into her. She wiggles her bottom, the size of your cock combining with the dual sensation to make her twitch. You simply hold yourself inside of her until you feel she’s able to take the pounding you’re about to give her. \n \n");
		...
		flags[kFLAGS._modPLAYERCAMEBEFORERIDING] = true;
	}
	simpleChoices("Anal", sexAnalHelspawn, "Riding", sexRidingHelspawn, "", null, "", null, "", null);
}
...
private function sexAnalHelspawn():void {
	...
	if(player.longestCockLength() <= 10){
		...
		if (player.ass.analLooseness <= ANAL_LOOSENESS_NORMAL){
	...
	if(player.longestCockLength() > 10 && player.longestCockLength() <= 18){ 
		...
		if (player.ass.analLooseness <= ANAL_LOOSENESS_NORMAL){ 
			...
			outputText("She smiles at you over her shoulder, “Well try to relax and remember to breathe.” She says matter of factly before adding, “...and try to hold still, I got this. \n \n");
	
			outputText("With that she begins to push back slowly, engulfing your " + player.cockDescript() + " as she pushes her tail deeper into your " + player.buttDescript() + ". Your body jerks and you wonder why anyone would want something this big inside of their " + player.assholeDescript() + ". As if reading your thoughts " + flags[kFLAGS.HELSPAWN_NAME] + " groans, your " + player.cockDescript() + " is nowhere near the length of the tail she pegs herself with so it’s no wonder she’s enjoying herself. Your " + player.cockDescript() + " feels like it’s fucking a spit slick tunnel of bliss while your " + player.assholeDescript() + " feels like it’s being forcibly invaded. You do your best to hold still as she fucks herself with your cock while filling your rear entrance. Soon the alien feeling is replaced by an odd combination of discomfort and pressure. You can’t deny that the feeling of her tail sliding through you is somewhat pleasurable. Then her tail hits something that causes your " + player.cockDescript() + " to jump inside her. \n \n");
	
			outputText("“Found it!” " + flags[kFLAGS.HELSPAWN_NAME] + " exclaims as she begins using your " + player.cockDescript() + " to fuck herself roughly while pegging you with her tail. With every incursion she hits that glorious spot inside you that makes you shiver. You can’t help moving your hips, fucking down into " + flags[kFLAGS.HELSPAWN_NAME] + "’s soft squishy ass even as she roughly pounds yours. The sight of your hard thrusts rippling through her gorgeous ass is one to behold. Combined with the dual sensations you can’t help but feel as though this is going to be over soon. \n \n");
		} else if (ANAL_LOOSENESS_STRETCHED > player.ass.analLooseness > ANAL_LOOSENESS_NORMAL){
			outputText("Being neither a master nor a newbie to taking anal penetration you fuck her at a slow pace. The way she matches your size has you pacing yourself but as soon as you’re used to the depth to which she plunges into your " + player.assholeDescript() + " you decide it’s time to speed up. Stroke by stroke you thrust faster until you’ve reached full speed. The dual sensations of fucking and being pegged have your body shuddering between thrusts. Beneath you " + flags[kFLAGS.HELSPAWN_NAME] + " is in a state of supreme bliss. The way her tight spit slick tailhole milks your " + player.cockDescript() + " while her tail manipulates your " + player.assholeDescript() + " has you dangerously close to the edge. \n \n");
		} else if (player.ass.analLooseness >= ANAL_LOOSENESS_STRETCHED){
			outputText("Being no stranger to taking anal penetration you begin to fuck " + flags[kFLAGS.HELSPAWN_NAME] + " as hard as you can. " + flags[kFLAGS.HELSPAWN_NAME] + " makes good on her promise and begins pumping her tail in and out of your " + player.assholeDescript() + ". Your voices blend together as you both are filled with the mind numbing rapture of your rapid coitus. Throwing caution to the wind you fuck her hard, reveling in the feeling of her tail manipulating your prostate while her ass milks your " + player.cockDescript() + ". You know it won’t be long now and you fuck towards your own climax with the fury of an animal. \n \n");
		}
	}
	...
	player.orgasm();
	simpleChoices("", null, "", null, "", null, "", null, "Next", postSexHelspawn);
}

private function sexRidingHelspawn():void {
	clearOutput();
	//HELSPAWN RIDING TEXT
	
	if(flags[kFLAGS._modPLAYERCAMEBEFORERIDING]){
		...
		if (flags[kFLAGS.HELSPAWN_HADSEX] != 1){
			...
			outputText(".” " + flags[kFLAGS.HELSPAWN_NAME] + " says with a grin, “I just… wow. We should spend more quality time with each other. I mean look at me, I’m shaking!” \n \n");
		...
		outputText("“Oh well,” she says with eyes full of mischief, giving your " + player.cockDescript() + " one last squeeze with her sopping wet vaginal walls before reaching back and sliding you out, painstakingly slowly. She turns, her naked form every bit as hypnotic as ever, and pushes you back to take a seat on a nearby rock. It's clear that she has a plan B as she straddles you, sitting just above your crotch and wrapping her scaly legs around your waist. “...Maybe next time,” she finishes in a sing song voice. \n \n");
	...
	if(player.totalCocks() == 1){
		...
		if(player.longestCockLength() <= 8){
			...
			outputText("“Mmmmm…” " + flags[kFLAGS.HELSPAWN_NAME] + " says as she grinds around your hard dick, “...I love it when you’re inside me ");
			if(flags[kFLAGS.HELSPAWN_DADDY] == 0) outputText("daddy");
			else outputText("[name]");
			outputText("; it just feels so good. \n \n");
			...
			outputText("When you release her she says, “");
			if(flags[kFLAGS.HELSPAWN_DADDY] == 0) outputText("daddy");
			else outputText("[name]");
			outputText(".” in a sexy voice as she grinds with your rigid cock still inside her slavering vaginal cocksleeve, “I love you so much ");
			if(flags[kFLAGS.HELSPAWN_DADDY] == 0) outputText("daddy");
			else outputText("[name]");
			outputText(". I love having you so deep inside me.” \n \n");
...
private function postSexHelspawn():void {
	...
	outputText("She pushes you away with a giggle, saying, “Stop it, [name].” \n \n");
	
	outputText("You smile and ask her if you’re doing it wrong, you of course know you’re not. \n \n");

	outputText("“I'm all tender,” she says as she rubs her belly shyly. “It’s too sensitive.” \n \n");
	...
	simpleChoices("", null, "", null, "", null, "", null, "Next", camp.returnToCampUseOneHour);
}
